...
C_SOURCES = semihost.c	myprintf.c # Enter list of all the C source files here
S_SOURCES = startup.S semihostDriver.S 	# Enter list of all the assembler source files here
...
# Linker Flags 
LINKER_SCRIPT = STM32F100C8v4.ld
